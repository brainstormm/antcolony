  ...
  <body>
	...
	<div class="container-fluid">
		...
		<?php
			...
			echo '<img src="'.$x.'" id="gravatar_icon" class="img-thumbnail" alt="Cinque Terre" width="200" height="200" style="margin: 20px; border: 3px solid grey;">';
			?>
			<form class="form-horizontal" role="form" method = "POST" action="" enctype="multipart/form-data">
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<button type="button" class="btn btn-success btn-lg" style="margin: 19px;">Edit Images</button>
					</div>
				</div>
			</form>
		</div>
