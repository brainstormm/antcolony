...
<?php
			...
			/*margin-left:32% -- Use below in case of addition of above button*/
			echo '<button type="button" class="btn btn-success btn-lg" id="send_message_btn" style="margin-left: 40px; margin-bottom: 30px;" onclick="sendme(\''.$dat['ID'].'\')">Send Message</button>';
?>
<?php
