...
<a href="./globaluserlist.php" class="list-group-item">Global User List</a>
		...
		<div class="container-fluid">
			<ul class="nav navbar-inverse navbar-right">
					...
					<ul class="nav navbar-inverse navbar-right">
					<?php echo'<li><a href="./userfeed.php" style="background-color:white"><span class="glyphicon glyphicon-inbox"></span> Your Posts</a></li>'; ?>
				</ul>
			<ul class="nav navbar-inverse navbar-right">
				<?php echo'<li><a href="./posts.php" style="background-color:white"><span class="glyphicon glyphicon-pencil" ></span>Create Post</a></li>'; ?>
			</ul>
			</div>
			<br>
			<h3 style="color:red; text-align:center">Your Feed</h3>
